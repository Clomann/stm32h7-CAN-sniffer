...
#define UPDATE_INGEST_PIPELINE_E_OK          IAP_UPDATE_INGEST_E_OK
#define UPDATE_INGEST_PIPELINE_E_PARAM       IAP_UPDATE_INGEST_E_PARAM
#define UPDATE_INGEST_PIPELINE_E_STATE       IAP_UPDATE_INGEST_E_STATE
#define UPDATE_INGEST_PIPELINE_E_UNAVAILABLE IAP_UPDATE_INGEST_E_UNAVAILABLE
#define UPDATE_INGEST_PIPELINE_E_SEQUENCE    IAP_UPDATE_INGEST_E_SEQUENCE
#define UPDATE_INGEST_PIPELINE_E_RANGE       IAP_UPDATE_INGEST_E_RANGE
#define UPDATE_INGEST_PIPELINE_E_ALIGN       IAP_UPDATE_INGEST_E_ALIGN
#define UPDATE_INGEST_PIPELINE_E_BACKEND     IAP_UPDATE_INGEST_E_BACKEND

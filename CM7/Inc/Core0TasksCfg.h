...
#define CORE0_TASK5_FUNCTION SdBridgeTask
...
#define CORE0_TASK0_PRIO (configMAX_PRIORITIES - 2U) // CanBridgeTask
#define CORE0_TASK1_PRIO (configMAX_PRIORITIES - 4U) // CanSendTask
#define CORE0_TASK2_PRIO (configMAX_PRIORITIES - 6U) // Core0Task0Main
#define CORE0_TASK3_PRIO (configMAX_PRIORITIES - 1U) // Core0Task1Main
#define CORE0_TASK4_PRIO (configMAX_PRIORITIES - 3U) // SpiTask
#define CORE0_TASK5_PRIO (configMAX_PRIORITIES - 5U) // SdBridgeTask

...
#define CORE0_TASK1_PRIO (configMAX_PRIORITIES - 3U)
#define CORE0_TASK2_PRIO (configMAX_PRIORITIES - 4U)
#define CORE0_TASK3_PRIO (configMAX_PRIORITIES - 4U)
#define CORE0_TASK4_PRIO (configMAX_PRIORITIES - 2U)

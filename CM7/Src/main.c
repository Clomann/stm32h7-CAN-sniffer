...
int main(void)
{
  ...
  SpiHandle1.Init.NSS               = SPI_NSS_HARD_OUTPUT;
  ...
  while (1)
  {
	...
	RetVal = HAL_SPI_TransmitReceive_DMA(&SpiHandle1, (uint8_t*)aTxBuffer, (uint8_t *)aRxBuffer, BUFFERSIZE);
	if (RetVal == HAL_BUSY)
	{
